...
<script type="text/javascript"
	src="js/jquery-core/jquery-1.4.2-ie-fix.min.js"></script>
...
<body
	style="background: url(img/joanna-kosinska-439233-unsplash.jpg) no-repeat center top;">
...
.shadow {
						...
						function() {
							...
							$("#BtnICalTest").click(
									function() {
										...
										jfcalplugin.loadICalSource("#mycal", $(
												"#iCalSource").val(), "html");
										return false;
									});
	...
	<h1 style="font-size: 30px; font-weight: bold;">Planificacion de
		clases</h1>
		...
		<div id="tabs-2">
			...
			<div id="example" style="margin: auto; width: 80%;">
				...
				<div class="shadow" style="border: 1px solid #aaaaaa; padding: 3px;">
					<b> Clickea en el calendario para agregar algun evento. </b>
				</div>
				...
				<div id="toolbar" class="ui-widget-header ui-corner-all"
					...
					&nbsp;&nbsp;&nbsp; Fecha: <input type="text" id="dateSelect"
						size="20" /> &nbsp;&nbsp;&nbsp;
				...
				<form>
					<fieldset>
						...
						<table style="width: 100%; padding: 5px;">
							<tr>
								<td><label>Inicio</label> <input type="text"
									name="startDate" id="startDate" value=""
									class="text ui-widget-content ui-corner-all"
									style="margin-bottom: 12px; width: 95%; padding: .4em;" /></td>
								<td>&nbsp;</td>
								<td><label>Hora inicio</label> <select id="startHour"
									class="text ui-widget-content ui-corner-all"
									style="margin-bottom: 12px; width: 95%; padding: .4em;">
								...
								<td>
								<td><label>Minuto inicio</label> <select id="startMin"
									class="text ui-widget-content ui-corner-all"
									style="margin-bottom: 12px; width: 95%; padding: .4em;">
								...
								<td>
								<td><label>Inicio AM/PM</label> <select id="startMeridiem"
									class="text ui-widget-content ui-corner-all"
									style="margin-bottom: 12px; width: 95%; padding: .4em;">
							...
							<tr>
								<td><label>Fecha fin</label> <input type="text"
									name="endDate" id="endDate" value=""
									class="text ui-widget-content ui-corner-all"
									style="margin-bottom: 12px; width: 95%; padding: .4em;" /></td>
								<td>&nbsp;</td>
								<td><label>Hora fin</label> <select id="endHour"
									class="text ui-widget-content ui-corner-all"
									style="margin-bottom: 12px; width: 95%; padding: .4em;">
										<option value="12" SELECTED>12</option>
										<option value="1">1</option>
								...
								<td>
								<td><label>Minuto fin</label> <select id="endMin"
									class="text ui-widget-content ui-corner-all"
									style="margin-bottom: 12px; width: 95%; padding: .4em;">
										<option value="00" SELECTED>00</option>
										<option value="10">10</option>
								...
								<td>
								<td><label>Fin AM/PM</label> <select id="endMeridiem"
									class="text ui-widget-content ui-corner-all"
									style="margin-bottom: 12px; width: 95%; padding: .4em;">
										<option value="AM" SELECTED>AM</option>
										<option value="PM">PM</option>
						...
						<table>
							<tr>
								...
								<td>&nbsp;&nbsp;&nbsp;</td>
								<td><label>Color de texto</label></td>
								<td>
