...
<link rel="stylesheet" type="text/css" href="css/Profesor/frontierCalendar/jquery-frontier-cal-1.3.2.css" />

<!-- Include CSS for color picker plugin (Not required for calendar plugin. Used for example.) -->
<link rel="stylesheet" type="text/css" href="css/Profesor/colorpicker/colorpicker.css" />

<!-- Include CSS for JQuery UI (Required for calendar plugin.) -->
<link rel="stylesheet" type="text/css" href="css/Profesor/jquery-ui/smoothness/jquery-ui-1.8.1.custom.css" />
...
-->
<script type="text/javascript" src="js/Profesor/jquery-core/jquery-1.4.2-ie-fix.min.js"></script>

<!-- Include JQuery UI (Required for calendar plugin.) -->
<script type="text/javascript" src="js/Profesor/jquery-ui/smoothness/jquery-ui-1.8.1.custom.min.js"></script>

<!-- Include color picker plugin (Not required for calendar plugin. Used for example.) -->
<script type="text/javascript" src="js/Profesor/colorpicker/colorpicker.js"></script>

<!-- Include jquery tooltip plugin (Not required for calendar plugin. Used for example.) -->
<script type="text/javascript" src="js/Profesor/jquery-qtip-1.0.0-rc3140944/jquery.qtip-1.0.js"></script>
...
-->
<script type="text/javascript" src="js/Profesor/lib/jshashtable-2.1.js"></script>

<!-- Include JQuery Frontier Calendar plugin -->
<script type="text/javascript" src="js/Profesor/frontierCalendar/jquery-frontier-cal-1.3.2.min.js"></script>
</head>
<body style="background: url(images/joanna-kosinska-439233-unsplash.jpg) no-repeat center top;">
...
$(document).ready(function(){	
	...
	function myApplyTooltip(divElm,agendaItem){
		...
		if(allDay){
			...
			displayData += "<b>Empieza:</b> " + startDate + "<br>" + "<b>Termina:</b> " + endDate + "<br><br>";
		}
...
<div id="tabs">
	...
	<div id="tabs-2">
		...
		<div class="shadow" style="border: 1px solid #aaaaaa; padding: 3px;">
			<b>
			Clickea en el calendario para agregar algun evento.
			</b>
		</div>
		...
		<div id="toolbar" class="ui-widget-header ui-corner-all" style="padding:3px; vertical-align: middle; white-space:nowrap; overflow: hidden;">
			...
			<button id="BtnNextMonth">Siguente mes</button>
			&nbsp;&nbsp;&nbsp;
		...
		<div id="display-event-form" title="Clase">
